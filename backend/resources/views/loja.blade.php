        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-4">
                    ...
                    <a href="https://wa.me/?text={{ urlencode('Confira essa Loja: ' . url()->current()) }}" target="_blank"
                ...
                @auth
                    <div class="dropdown">
                        <button class="btn btn-outline-secondary btn-sm d-flex align-items-center gap-2" type="button"
...
@push('scripts')
    <script>
        ...
        window.formattedAddress =
            "{{ $store->address }}, {{ $store->number }} - {{ $store->district }}, {{ $store->city }}";
    </script>

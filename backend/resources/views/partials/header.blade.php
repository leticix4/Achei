@php
    ...
    $esconderCriarConta = request()->routeIs('cadastro-completo');
@endphp
    ...
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center">
            <div class="nav-icons d-flex">
                ...
                <!-- Botão CRIAR CONTA (SOME na rota cadastro-completo) -->
                @if (!$esconderCriarConta)
                    <a href="{{ route('cadastro-completo') }}" class="btn btn-outline-light ms-2">
                        Criar conta
                    </a>
                @endif
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="cadastroPF">
                                                    <form id="formPF">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="password" id="senhaPF"
                                                                class="form-control" required>
                                                        </div>
                                                ...
                                                <div class="tab-pane fade" id="cadastroPJ">
                                                    <form id="formPJ">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label">Criar senha*</label>
                                                            <input type="password" id="senhaPJ"
                                                                class="form-control" required>
                                                        </div>
        ...
        <ul class="nav">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu custom-dropdown" aria-labelledby="categoriasDropdown">
                    ...
                    <li><a class="dropdown-item" href="{{ route('casa-moveis') }}">Casa e Móveis</a></li>
